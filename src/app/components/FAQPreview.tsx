...
const faqs = [
  ...
  },
  {
    ...
    a: "No. La evaluación de su caso es completamente gratuita y sin compromiso. Operamos bajo una política de éxito: nuestros honorarios están condicionados a la eliminación efectiva de su deuda de los registros comerciales. Si no cumplimos, usted no paga.",
  },
  {
